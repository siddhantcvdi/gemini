  ...
  return (
    <div className="w-[100%] h-14 bg-[#1e1f20] p-6 sm:hidden">
      <button
        ...
        className={`absolute z-10 top-0 mt-3 right-2 w-[125px] flex h-[48px] rounded-full sm:hidden ml-1 items-center justify-between p-3 cursor-pointer} ${!isExpanded?'active:bg-[#32373d]':''}`}>
        <img src={plus} alt="" />
